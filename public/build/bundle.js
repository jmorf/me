    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img3, file$1, 16, 8, 662);
    			attr_dev(div3, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div3, file$1, 15, 4, 599);
    			...
    			add_location(img4, file$1, 19, 8, 795);
    			attr_dev(div4, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div4, file$1, 18, 4, 732);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 26, 6, 834);
    			attr_dev(div2, "class", "block");
    			add_location(div2, file, 25, 5, 808);
    			attr_dev(p1, "class", "text-base");
    			add_location(p1, file, 32, 6, 1039);
    			attr_dev(div3, "class", "block max-w-3xl mx-auto");
    			add_location(div3, file, 31, 5, 995);
    			attr_dev(div4, "class", "block");
    			add_location(div4, file, 44, 5, 1556);
    			attr_dev(div5, "class", "block");
    			add_location(div5, file, 47, 5, 1613);
    			...
    			add_location(meta, file, 58, 1, 1758);
    			attr_dev(html, "lang", "en");
    			add_location(html, file, 63, 1, 1884);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
