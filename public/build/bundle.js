...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "A few companies I've been involved in";
    			t1 = space();
    			div9 = element("div");
    			div0 = element("div");
    			img0 = element("img");
    			...
    			attr_dev(img0, "class", "max-h-12 object-contain");
    			if (img0.src !== (img0_src_value = "cheakamus.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "Titan");
    			add_location(img0, file$1, 7, 8, 261);
    			attr_dev(div0, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div0, file$1, 6, 4, 198);
    			attr_dev(img1, "class", "max-h-12 object-contain");
    			if (img1.src !== (img1_src_value = "strong.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Logo.com");
    			add_location(img1, file$1, 10, 8, 411);
    			attr_dev(div1, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div1, file$1, 9, 4, 348);
    			attr_dev(img2, "class", "max-h-12 object-contain");
    			if (img2.src !== (img2_src_value = "titan.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Titan");
    			add_location(img2, file$1, 13, 8, 561);
    			attr_dev(div2, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div2, file$1, 12, 4, 498);
    			attr_dev(img3, "class", "max-h-12 object-contain");
    			if (img3.src !== (img3_src_value = "logo.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Logo.com");
    			add_location(img3, file$1, 16, 8, 707);
    			attr_dev(div3, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div3, file$1, 15, 4, 644);
    			attr_dev(img4, "class", "max-h-12 object-contain");
    			if (img4.src !== (img4_src_value = "ocean.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Ocean Networks");
    			add_location(img4, file$1, 19, 8, 855);
    			attr_dev(div4, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div4, file$1, 18, 4, 792);
    			attr_dev(img5, "class", "max-h-12 object-contain");
    			if (img5.src !== (img5_src_value = "resume.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "Resume.com");
    			add_location(img5, file$1, 26, 8, 1054);
    			attr_dev(div5, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div5, file$1, 25, 4, 991);
    			attr_dev(div6, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div6, file$1, 32, 4, 1187);
    			attr_dev(img6, "class", "max-h-12 object-contain");
    			if (img6.src !== (img6_src_value = "namescon.png")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "NamesCon");
    			add_location(img6, file$1, 34, 8, 1311);
    			attr_dev(div7, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div7, file$1, 33, 4, 1248);
    			attr_dev(div8, "class", "col-span-1 flex justify-center py-8 px-8");
    			add_location(div8, file$1, 40, 4, 1444);
    			attr_dev(div9, "class", "mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8 place-self-center");
    			add_location(div9, file$1, 3, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			meta = element("meta");
    			html = element("html");
    			attr_dev(img, "class", "w-64 h-64 md:w-72 md:h-64 lg:w-96 lg:h-96 rounded-full ring-4 ring-white object-center mx-auto hover:opacity-25 transition-opacity duration-1000 ease-out");
    			...
    			attr_dev(span0, "class", "block md:inline-block");
    			add_location(span0, file, 22, 7, 785);
    			attr_dev(span1, "class", "block md:inline-block");
    			add_location(span1, file, 23, 7, 840);
    			attr_dev(h1, "class", "font-sans mt-1 text-6xl font-bold sm:text-5xl sm:tracking-tight lg:text-6xl");
    			add_location(h1, file, 19, 6, 675);
    			attr_dev(div1, "class", "block");
    			add_location(div1, file, 18, 5, 649);
    			attr_dev(p0, "class", "text-center text-xl font-bold tracking-wider");
    			add_location(p0, file, 27, 6, 948);
    			attr_dev(div2, "class", "block");
    			add_location(div2, file, 26, 5, 922);
    			attr_dev(p1, "class", "text-base");
    			add_location(p1, file, 33, 6, 1153);
    			attr_dev(div3, "class", "block max-w-3xl mx-auto");
    			add_location(div3, file, 32, 5, 1109);
    			attr_dev(div4, "class", "block");
    			add_location(div4, file, 45, 5, 1670);
    			attr_dev(div5, "class", "block");
    			add_location(div5, file, 48, 5, 1727);
    			attr_dev(div6, "class", "space-y-8");
    			add_location(div6, file, 10, 4, 328);
    			attr_dev(div7, "class", "max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8");
    			add_location(div7, file, 9, 3, 256);
    			attr_dev(div8, "class", "container max-w-5xl px-4 mx-auto ");
    			add_location(div8, file, 8, 2, 205);
    			attr_dev(div9, "class", "h-full w-full bg-gray-800 text-white font-sans text-center");
    			add_location(div9, file, 7, 1, 130);
    			...
    			add_location(meta, file, 59, 1, 1872);
    			attr_dev(html, "lang", "en");
    			add_location(html, file, 64, 1, 1998);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(companies, div4, null);
    			append_dev(div6, t9);
